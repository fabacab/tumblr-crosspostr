        ...
        <tr>
            ...
            <td>
                <input class="regular-text"
                    id="<?php print esc_attr($this->prefix);?>_additional_tags"
                    name="<?php print esc_attr($this->prefix);?>_settings[additional_tags]"
                    value="<?php if (isset($options['additional_tags'])) : print esc_attr(implode(', ', $options['additional_tags'])); endif;?>"
                    placeholder="<?php esc_attr_e('crosspost, magic', 'tumblr-crosspostr');?>"
                />
